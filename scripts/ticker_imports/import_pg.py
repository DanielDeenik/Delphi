#!/usr/bin/env python3
"""
Import script for PG data.

This script imports time series data for PG from Alpha Vantage to BigQuery.
It can be used to update the data for the PG notebook.
"""
import os
import sys
import logging
...
log_file = log_dir / f"import_PG_{datetime.now().strftime('%Y%m%d_%H%M%S')}.log"
...
def parse_args():
    ...
    parser = argparse.ArgumentParser(description="Import PG data from Alpha Vantage to BigQuery")
