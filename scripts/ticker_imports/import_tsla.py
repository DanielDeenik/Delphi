#!/usr/bin/env python3
"""
Import script for TSLA data.

This script imports time series data for TSLA from Alpha Vantage to BigQuery.
It can be used to update the data for the TSLA notebook.
"""
import os
import sys
import logging
...
log_file = log_dir / f"import_TSLA_{datetime.now().strftime('%Y%m%d_%H%M%S')}.log"
...
def parse_args():
    ...
    parser = argparse.ArgumentParser(description="Import TSLA data from Alpha Vantage to BigQuery")
