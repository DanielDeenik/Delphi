#!/usr/bin/env python3
"""
Import script for NVDA data.

This script imports time series data for NVDA from Alpha Vantage to BigQuery.
It can be used to update the data for the NVDA notebook.
"""
import os
import sys
import logging
...
log_file = log_dir / f"import_NVDA_{datetime.now().strftime('%Y%m%d_%H%M%S')}.log"
...
def parse_args():
    ...
    parser = argparse.ArgumentParser(description="Import NVDA data from Alpha Vantage to BigQuery")
