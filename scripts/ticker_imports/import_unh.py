#!/usr/bin/env python3
"""
Import script for UNH data.

This script imports time series data for UNH from Alpha Vantage to BigQuery.
It can be used to update the data for the UNH notebook.
"""
import os
import sys
import logging
...
log_file = log_dir / f"import_UNH_{datetime.now().strftime('%Y%m%d_%H%M%S')}.log"
...
def parse_args():
    ...
    parser = argparse.ArgumentParser(description="Import UNH data from Alpha Vantage to BigQuery")
