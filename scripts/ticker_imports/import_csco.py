#!/usr/bin/env python3
"""
Import script for CSCO data.

This script imports time series data for CSCO from Alpha Vantage to BigQuery.
It can be used to update the data for the CSCO notebook.
"""
import os
import sys
import logging
...
log_file = log_dir / f"import_CSCO_{datetime.now().strftime('%Y%m%d_%H%M%S')}.log"
...
def parse_args():
    ...
    parser = argparse.ArgumentParser(description="Import CSCO data from Alpha Vantage to BigQuery")
