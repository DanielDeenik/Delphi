#!/usr/bin/env python3
"""
Import script for MA data.

This script imports time series data for MA from Alpha Vantage to BigQuery.
It can be used to update the data for the MA notebook.
"""
import os
import sys
import logging
...
log_file = log_dir / f"import_MA_{datetime.now().strftime('%Y%m%d_%H%M%S')}.log"
...
def parse_args():
    ...
    parser = argparse.ArgumentParser(description="Import MA data from Alpha Vantage to BigQuery")
