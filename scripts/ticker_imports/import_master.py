#!/usr/bin/env python3
"""
Import script for MASTER data.

This script imports time series data for MASTER from Alpha Vantage to BigQuery.
It can be used to update the data for the MASTER notebook.
"""
import os
import sys
import logging
...
log_file = log_dir / f"import_MASTER_{datetime.now().strftime('%Y%m%d_%H%M%S')}.log"
...
def parse_args():
    ...
    parser = argparse.ArgumentParser(description="Import MASTER data from Alpha Vantage to BigQuery")
