#!/usr/bin/env python3
"""
Import script for BAC data.

This script imports time series data for BAC from Alpha Vantage to BigQuery.
It can be used to update the data for the BAC notebook.
"""
import os
import sys
import logging
...
log_file = log_dir / f"import_BAC_{datetime.now().strftime('%Y%m%d_%H%M%S')}.log"
...
def parse_args():
    ...
    parser = argparse.ArgumentParser(description="Import BAC data from Alpha Vantage to BigQuery")
