#!/usr/bin/env python3
"""
Import script for META data.

This script imports time series data for META from Alpha Vantage to BigQuery.
It can be used to update the data for the META notebook.
"""
import os
import sys
import logging
...
log_file = log_dir / f"import_META_{datetime.now().strftime('%Y%m%d_%H%M%S')}.log"
...
def parse_args():
    ...
    parser = argparse.ArgumentParser(description="Import META data from Alpha Vantage to BigQuery")
