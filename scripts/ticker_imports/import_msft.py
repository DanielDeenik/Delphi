#!/usr/bin/env python3
"""
Import script for MSFT data.

This script imports time series data for MSFT from Alpha Vantage to BigQuery.
It can be used to update the data for the MSFT notebook.
"""
import os
import sys
import logging
...
log_file = log_dir / f"import_MSFT_{datetime.now().strftime('%Y%m%d_%H%M%S')}.log"
...
def parse_args():
    ...
    parser = argparse.ArgumentParser(description="Import MSFT data from Alpha Vantage to BigQuery")
