#!/usr/bin/env python3
"""
Import script for HD data.

This script imports time series data for HD from Alpha Vantage to BigQuery.
It can be used to update the data for the HD notebook.
"""
import os
import sys
import logging
...
log_file = log_dir / f"import_HD_{datetime.now().strftime('%Y%m%d_%H%M%S')}.log"
...
def parse_args():
    ...
    parser = argparse.ArgumentParser(description="Import HD data from Alpha Vantage to BigQuery")
