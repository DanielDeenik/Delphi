#!/usr/bin/env python3
"""
Import script for JNJ data.

This script imports time series data for JNJ from Alpha Vantage to BigQuery.
It can be used to update the data for the JNJ notebook.
"""
import os
import sys
import logging
...
log_file = log_dir / f"import_JNJ_{datetime.now().strftime('%Y%m%d_%H%M%S')}.log"
...
def parse_args():
    ...
    parser = argparse.ArgumentParser(description="Import JNJ data from Alpha Vantage to BigQuery")
