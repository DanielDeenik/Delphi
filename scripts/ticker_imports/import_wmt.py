#!/usr/bin/env python3
"""
Import script for WMT data.

This script imports time series data for WMT from Alpha Vantage to BigQuery.
It can be used to update the data for the WMT notebook.
"""
import os
import sys
import logging
...
log_file = log_dir / f"import_WMT_{datetime.now().strftime('%Y%m%d_%H%M%S')}.log"
...
def parse_args():
    ...
    parser = argparse.ArgumentParser(description="Import WMT data from Alpha Vantage to BigQuery")
