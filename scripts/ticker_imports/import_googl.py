#!/usr/bin/env python3
"""
Import script for GOOGL data.

This script imports time series data for GOOGL from Alpha Vantage to BigQuery.
It can be used to update the data for the GOOGL notebook.
"""
import os
import sys
import logging
...
log_file = log_dir / f"import_GOOGL_{datetime.now().strftime('%Y%m%d_%H%M%S')}.log"
...
def parse_args():
    ...
    parser = argparse.ArgumentParser(description="Import GOOGL data from Alpha Vantage to BigQuery")
