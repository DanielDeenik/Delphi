#!/usr/bin/env python3
"""
Import script for PFE data.

This script imports time series data for PFE from Alpha Vantage to BigQuery.
It can be used to update the data for the PFE notebook.
"""
import os
import sys
import logging
...
log_file = log_dir / f"import_PFE_{datetime.now().strftime('%Y%m%d_%H%M%S')}.log"
...
def parse_args():
    ...
    parser = argparse.ArgumentParser(description="Import PFE data from Alpha Vantage to BigQuery")
