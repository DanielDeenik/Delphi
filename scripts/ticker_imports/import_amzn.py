#!/usr/bin/env python3
"""
Import script for AMZN data.

This script imports time series data for AMZN from Alpha Vantage to BigQuery.
It can be used to update the data for the AMZN notebook.
"""
import os
import sys
import logging
...
log_file = log_dir / f"import_AMZN_{datetime.now().strftime('%Y%m%d_%H%M%S')}.log"
...
def parse_args():
    ...
    parser = argparse.ArgumentParser(description="Import AMZN data from Alpha Vantage to BigQuery")
