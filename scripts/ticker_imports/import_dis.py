#!/usr/bin/env python3
"""
Import script for DIS data.

This script imports time series data for DIS from Alpha Vantage to BigQuery.
It can be used to update the data for the DIS notebook.
"""
import os
import sys
import logging
...
log_file = log_dir / f"import_DIS_{datetime.now().strftime('%Y%m%d_%H%M%S')}.log"
...
def parse_args():
    ...
    parser = argparse.ArgumentParser(description="Import DIS data from Alpha Vantage to BigQuery")
