#!/usr/bin/env python3
"""
Import script for JPM data.

This script imports time series data for JPM from Alpha Vantage to BigQuery.
It can be used to update the data for the JPM notebook.
"""
import os
import sys
import logging
...
log_file = log_dir / f"import_JPM_{datetime.now().strftime('%Y%m%d_%H%M%S')}.log"
...
def parse_args():
    ...
    parser = argparse.ArgumentParser(description="Import JPM data from Alpha Vantage to BigQuery")
