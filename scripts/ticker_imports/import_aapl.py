#!/usr/bin/env python3
"""
Import script for AAPL data.

This script imports time series data for AAPL from Alpha Vantage to BigQuery.
It can be used to update the data for the AAPL notebook.
"""
import os
import sys
import logging
...
log_file = log_dir / f"import_AAPL_{datetime.now().strftime('%Y%m%d_%H%M%S')}.log"
...
def parse_args():
    ...
    parser = argparse.ArgumentParser(description="Import AAPL data from Alpha Vantage to BigQuery")
