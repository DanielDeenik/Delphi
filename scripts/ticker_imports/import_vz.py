#!/usr/bin/env python3
"""
Import script for VZ data.

This script imports time series data for VZ from Alpha Vantage to BigQuery.
It can be used to update the data for the VZ notebook.
"""
import os
import sys
import logging
...
log_file = log_dir / f"import_VZ_{datetime.now().strftime('%Y%m%d_%H%M%S')}.log"
...
def parse_args():
    ...
    parser = argparse.ArgumentParser(description="Import VZ data from Alpha Vantage to BigQuery")
